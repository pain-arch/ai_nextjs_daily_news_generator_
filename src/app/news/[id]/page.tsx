    ...
    <section className="py-12">
      <article className="max-w-4xl mx-auto p-6 shadow-md border rounded-lg">
        ...
        <p>
          ...
          magni fugiat ducimus aliquid ipsa quaerat provident consequuntur autem
          excepturi voluptatum reiciendis incidunt illo et ad voluptate quas
          similique non. Lorem ipsum dolor sit amet consectetur, adipisicing
          elit. Facere, similique obcaecati dolores neque eveniet ullam
          voluptatum eum eos consectetur quis libero consequatur minus odit,
          quasi ratione, harum tempora quos sint?
        </p>
      </article>
    </section>
  );
